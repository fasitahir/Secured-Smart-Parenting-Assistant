...
import 'otp_screen.dart'; // Ensure this import is present
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> registerUser() async {
    ...
    final response = await http.post(
      Uri.parse("https://127.0.0.1:8000/signup"),
    ...
    if (response.statusCode == 200) {
      ...
      if (detail is List) {
        message = detail.join(", "); // Join list of errors into a string
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Colors.blueAccent, // Adjust color
                    ),
                    child: _isLoading
